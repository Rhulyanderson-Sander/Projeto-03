$(function(){
    ...
    function initSlider(){
        ...
        for(var i = 0; i < amt; i++){
            if(i == 0){
                $('.slider-bullets').append('<span style="background-color: rgb(163, 161, 161)"></span>')
            } else{
    ...
    function goToSlider(curIndex){
        ...
        $('.slider-bullets span').css('background-color','rgb(217, 215, 215)')
        $('.slider-bullets span').eq(curIndex).css('background-color','rgb(163, 161, 161)')
